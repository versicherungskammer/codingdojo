...
public class cavemen_test {
    ...
    public static void main(String[] args) {
        test("SPBBBSPSPSPSPSPSPSPSPSPSPP");
    ...
    public static void test(String opponent) {
        ...
        for (char c : opponent.toCharArray()) {
            ...
            if (result != null) {
//                ArrayList<String> player_actions = new ArrayList<>();
//                player_actions.add(myActions);
//                System.out.println(player_actions);
                System.out.print(myActions + "," + opponentsActions);
                System.out.println(" - " + result);
                return;
            }
        }
//        ArrayList<String> enemy_action = new ArrayList<>();
//        enemy_action.add(opponentsActions);
